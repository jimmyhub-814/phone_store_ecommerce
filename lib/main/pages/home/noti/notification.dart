...
class _NotificationPageState extends State<NotificationPage>
      ...
      body: _notificationStream == null
          ...
          : StreamBuilder<List<NotificationModel>>(
              ...
              builder: (context, snapshot) {
                ...
                // sort notification trong từng group
  ...
  // Widget Shimmer Loading đẹp hơn
...
// 1. Cải thiện Thẻ thông báo (Notification Card)
  Widget _buildNotiCard(int index, List<NotificationList> list, bool isExpanded,
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: read ? Colors.transparent : AppColors.primary.withValues(alpha:0.1),
          width: 1,
        ),
        boxShadow: [
          BoxShadow(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          onExpansionChanged: (expanded) {
            setState(() => expandedGroups[index] = expanded);
            if (expanded && !read) {
              context.read<NotificationProvider>().readNotification(orderId);
            }
          },
          leading: Container(
          ...
          children:
              others.map((noti) => _buildSubNotiItem(noti, orderId)).toList(),
        ),
      ),
    );
  }

  // 2. Widget cho các thông báo con bên trong
